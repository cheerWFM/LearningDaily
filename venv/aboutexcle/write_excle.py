...
def set_style(name,height,blod=False,format_str=''):
...
ws.write(0,0,1234.56,set_style('Times New Roman',220,blod=True,format_str='#,##0.00'))
ws.write(1,0,datetime.now(),set_style('Times New Roman',220,blod=False,format_str="DD-MM-YYYY"))

styleOK = xlwt.easyxf('pattern:fore_colour light_blue;'
                      'font:colour green,bold True;')

pattern = xlwt.Pattern() # 实例化样式类
